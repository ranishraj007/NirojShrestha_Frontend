...
const Footer = () => {
  return (
    <footer
      style={{
        background:
          "linear-gradient(180deg, #424242 0%, #37474F 50%, #263238 100%)",
      }}
      className="text-gray-300 pt-16 pb-8 border-t border-gray-700 relative z-10"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <p className="mb-5 text-sm leading-relaxed text-gray-400">
              ...
              and exclusive offers right to your inbox.
            </p>
            <form
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 pt-8 border-t border-gray-600/50 text-sm flex flex-col md:flex-row justify-between items-center gap-4 text-gray-400">
        <p>
          &copy; {new Date().getFullYear()} Niroj Shrestha. All rights reserved.
        </p>
        <div className="flex gap-6">
          <Link
            to="/privacy-policy"
            className="hover:text-white transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-white hover:after:w-full after:transition-all after:duration-300"
          >
            Privacy Policy
          </Link>
          <Link
